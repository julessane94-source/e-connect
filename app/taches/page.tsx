...
export default function Taches() {
  ...
  const tasks = [
    { id: 1, title: "Rapport mensuel d'activité", assignee: "Admin", dueDate: "25/06/2024", priority: "Haute", status: "En cours", progress: 60, category: "Rapport" },
    { id: 2, title: "Validation des actes d'état civil", assignee: "Marie Diouf", dueDate: "20/06/2024", priority: "Moyenne", status: "En retard", progress: 30, category: "Validation" },
    { id: 3, title: "Mise à jour des documents", assignee: "Aliou Sow", dueDate: "30/06/2024", priority: "Basse", status: "À faire", progress: 0, category: "Documentation" },
    { id: 4, title: "Rapport trimestriel", assignee: "Fatou Ndiaye", dueDate: "15/06/2024", priority: "Haute", status: "Terminée", progress: 100, category: "Rapport" },
    { id: 5, title: "Réunion d'équipe", assignee: "Admin", dueDate: "22/06/2024", priority: "Moyenne", status: "En cours", progress: 75, category: "Réunion" },
  ];
                  ...
                  >
                    ...
                    <td className="py-3 px-4 text-right">
                      <div className="flex items-center justify-end gap-1">
                        ...
                        <button className="p-1.5 rounded-lg hover:bg-red-100 dark:hover:bg-red-900/20 transition" title="Supprimer" onClick={() => { if(confirm("Supprimer cette tâche ?")) alert("🗑️ Tâche supprimée!") }}>
