...
export default function Activites() {
  ...
  const activities = [
    { title: "Nouveau certificat de naissance #2024-001", user: "Moussa Diop", date: "15/06/2024 10:30", type: "création", icon: "📄" },
    { title: "Demande citoyenne validée - Marie Diouf", user: "Aissatou Sow", date: "15/06/2024 09:15", type: "validation", icon: "✅" },
    { title: "Nouveau courrier entrant #2024-045", user: "Ministère Intérieur", date: "14/06/2024 16:45", type: "courrier", icon: "📧" },
    { title: "Rapport mensuel généré", user: "Système", date: "14/06/2024 14:00", type: "rapport", icon: "📊" },
  ];
