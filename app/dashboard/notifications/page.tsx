...
export default function NotificationsPage() {
  const [notifications, setNotifications] = useState([
    { id: 1, title: "Nouveau message de M. Diop", message: "Bonjour, j'ai une question concernant le dossier #2024-001", time: "Il y a 5 minutes", type: "message", read: false },
    { id: 2, title: "Document à signer: Convention #2024-12", message: "Le document nécessite votre signature électronique", time: "Il y a 30 minutes", type: "document", read: false },
