...
export default function HistoriqueDemandes() {
  ...
  const historique = [
    { id: "#DEM-001", type: "Certificat de naissance", citizen: "Marie Diouf", date: "15/06/2024", status: "Validée", user: "Admin" },
    { id: "#DEM-002", type: "Extrait de mariage", citizen: "Aliou Sow", date: "14/06/2024", status: "Validée", user: "Chef service" },
    { id: "#DEM-003", type: "Certificat de résidence", citizen: "Fatou Ndiaye", date: "13/06/2024", status: "Rejetée", user: "Admin" },
    { id: "#DEM-004", type: "Acte de naissance", citizen: "Moussa Diop", date: "12/06/2024", status: "Validée", user: "Agent" },
    { id: "#DEM-005", type: "Certificat de mariage", citizen: "Aissatou Fall", date: "11/06/2024", status: "En attente", user: "-" },
  ];
    ...
    <div className="space-y-6">
      ...
      <div className="card-modern p-6">
        <div className="flex flex-col md:flex-row gap-4">
          ...
          <button className="btn-secondary flex items-center gap-2" onClick={() => alert("⬇️ Export en cours...")}>
            <Download size={18} />
            Exporter
          </button>
        </div>
